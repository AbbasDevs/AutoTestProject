...
public class TC39_DelNpm_n extends ApiTestBase {
    @Test
    public void test() {
        // 1. Construct API Request (Headers, Params) and Send HTTP Request
        Assert.assertEquals(given().spec(ApiBase.getFrmReq()).when().delete(ApiRts.delAcc_url).jsonPath().getString("responseCode"), "400");
