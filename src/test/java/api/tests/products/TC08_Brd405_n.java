...
public class TC08_Brd405_n extends ApiTestBase {
    @Test
    public void test() {
        // 1. Construct API Request (Headers, Params) and Send HTTP Request
        Assert.assertEquals(given().spec(ApiBase.getFrmReq()).when().put(ApiRts.brndsList_url).jsonPath().getString("responseCode"), "405");
